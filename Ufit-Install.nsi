...
;  !insertmacro MUI_PAGE_WELCOME
  ...
  ;Finish page
  !define MUI_FINISHPAGE_TITLE "Instalation is finished"
  !define MUI_FINISHPAGE_TEXT "Congratulation, Ufit was succesfully installed on your system."
  !define MUI_FINISHPAGE_NOREBOOTSUPPORT
  !define MUI_FINISHPAGE_RUN "$INSTDIR\bin\ufit.exe"
...
;  FILE dist\ufit\ufit.exe
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\Ufit.lnk" "$INSTDIR\bin\ufit.exe"
